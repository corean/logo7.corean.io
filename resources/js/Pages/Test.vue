                ...
                <table class="table table-vcenter card-table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-muted">
                        <a href="#" class="text-reset">mlebarree5@unc.edu</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-muted">
                        <a href="#" class="text-reset">epoetz6@free.fr</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-muted">Tax Accountant, Engineering</td>
                      <td class="text-muted">
                        <a href="#" class="text-reset">ccharlwood8@nifty.com</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-muted">Staff Scientist, Legal</td>
                      <td class="text-muted">
                        <a href="#" class="text-reset"
                          >hshelper9@woothemes.com</a
                        >
                      </td>
                      <td class="text-muted">Admin</td>
                      <td>
                ...
                <table class="table table-vcenter table-mobile-md card-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-muted" data-label="Role">Admin</td>
                      <td>
                        <div class="btn-list flex-nowrap">
                          <a href="#" class="btn"> Edit </a>
                          <div class="dropdown">
                    ...
                    <tr>
                      ...
                      <td class="text-muted" data-label="Role">Owner</td>
                      <td>
                        <div class="btn-list flex-nowrap">
                          <a href="#" class="btn"> Edit </a>
                          <div class="dropdown">
                      ...
                      <td data-label="Name">
                        <div class="d-flex py-1 align-items-center">
                          <span
                            class="avatar me-2"
                            style="
                              background-image: url(./static/avatars/008f.jpg);
                            "
                          ></span>
                          <div class="flex-fill">
                            <div class="font-weight-medium">Tessie Curzon</div>
                            <div class="text-muted">
                              <a href="#" class="text-reset">tcurzonj@hp.com</a>
                            </div>
                          </div>
                        </div>
                      </td>
